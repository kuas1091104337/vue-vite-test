...
<template>
  <WelcomeItem>
    <template #icon>
      <SvgIcon name="icon-documentation" className="svg-shadow" color="#fff" />
      <!-- <DocumentationIcon /> -->
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <SvgIcon name="icon-ecosystem" className="svg-shadow" color="#fff"/>
      <!-- <EcosystemIcon /> -->
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <!-- <CommunityIcon /> -->
      <SvgIcon name="icon-community" className="svg-shadow" color="#fff"/>
    </template>
  ...
  <WelcomeItem>
    <template #icon>
      <SvgIcon name="icon-support" className="svg-shadow" color="#fff"/>
      <!-- <SupportIcon /> -->
    </template>
    <template #heading>Support Vue</template>
    As an independent project, 
    Vue relies on community backing for its sustainability.
    You can help us by
